...
public:
	...
	double Area() {
		...
		{
			throw ExTriangSide("Стороны треугольника не равны!");
		}
...
int main() {
	...
	std::cout << "Введите значения сторон равностороннего треугольника: " << '\n';
	std::cin >> a >> b >> c;
...
//int main() {
//	system("chcp 1251");
//	cout << "Введите целое значение числителя числа для расчета частного 2х чисел:\n";
//	int number1/*, number2*/;
//	cin >> number1;
//	//cin >> number2;
//	/*try {
